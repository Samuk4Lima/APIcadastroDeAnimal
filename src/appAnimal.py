...
from fastapi.middleware.cors import CORSMiddleware #Permisao para que origens diferentes e cadastradas
#possam acessar a api na web
...
origins = ['http://localhost:5500'] #porta padrao do live server

# definindo o CORS (Cross-Origin Resource Sharing)
app.add_middleware(
    CORSMiddleware,
